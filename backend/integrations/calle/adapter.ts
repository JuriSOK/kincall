...
export interface FamilyCallInput {
  ...
  // (backend/agents/family/context-brief.ts, DEC-022). Deliberately separate
...
// rather than the raw facts: backend/agents/notification/message.ts is
...
export interface CallResult {
  ...
  // with backend/integrations/calle/schemas.ts before use (TECHNICAL_ARCHITECTURE.md §5: the
