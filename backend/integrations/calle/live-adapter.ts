import { buildCompanionTask, companionResultSchema } from "@/backend/agents/companion/prompt";
import { buildFamilyResultSchema, buildFamilyTask } from "@/backend/agents/family/prompt";
import {
  buildPersonNotificationResultSchema,
  buildPersonNotificationTask,
} from "@/backend/agents/notification/prompt";
