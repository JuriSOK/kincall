...
// PREFERRED_LANGUAGES in shared/validation/profile.ts. English display names
...
// CONVERSATION_PROFILES in shared/validation/profile.ts — the profiles
// backend/agents/companion/prompt.ts actually implements guidance for.
...
// shape in shared/presentation/format-schedule.ts.
