...
// The profiles backend/agents/companion/prompt.ts actually understands
...
// Empty/absent means "use the initials fallback" (frontend/components/avatars/avatar.tsx),
...
// resolve to a real graphic (shared/utilities/avatars.ts is the single source of truth
...
// comment in backend/persistence/repository.ts for why.
