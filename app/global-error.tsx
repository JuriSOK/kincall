      ...
      >
        <main
          style={{
            ...
            padding: "1.75rem",
            boxShadow: "0 1px 3px rgb(74 52 38 / 0.06), 0 6px 16px -6px rgb(74 52 38 / 0.10)",
          }}
        >
          ...
          <p style={{ margin: "0 0 1.25rem", fontSize: "0.875rem", lineHeight: 1.6, color: "#6b5f56" }}>
          ...
          {error.digest ? (
            <p style={{ marginTop: "1.25rem", fontSize: "0.75rem", color: "#8d8078" }}>
