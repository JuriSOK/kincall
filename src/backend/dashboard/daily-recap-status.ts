...
import { describePersonStatus, type StatusTone } from "@/backend/presentation/person-status";
...
// src/shared/presentation/format-date.ts's formatDayKey and
// src/backend/scheduling/next-check-in.ts's ymdInZone already use. Kept local rather
