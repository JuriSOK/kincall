...
// src/shared/presentation/format-date.ts already relies on) — safe, dependency-free,
...
export interface CheckInSchedule {
  ...
  // process's. Assumed already validated (src/shared/validation/profile.ts's
...
// Mirrors src/shared/validation/profile.ts's CALL_TIME_PATTERN exactly (not
...
// same trick src/shared/presentation/format-date.ts's formatDayKey already uses.
