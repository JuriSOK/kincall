...
// cascade tries FIRST. Nothing here places a call; src/backend/orchestration/engine.ts
...
// src/backend/orchestration/engine.ts's own contactBlockedReason/selectCascadeTarget,
...
// src/backend/scheduling/next-check-in.ts already relies on.

import type { TrustedContact } from "@/shared/domain/types";

const TIME_PATTERN = /^([01]\d|2[0-3]):([0-5]\d)$/;

// src/shared/validation/profile.ts independently validates "HH:MM" at the input
