...
// application shell under src/app/(app)/ — this page has no Nav, no profile
...
// a redrawn vector mark (src/frontend/components/kincall-mark.tsx), replacing the earlier
    ...
    <main className="flex flex-1 flex-col">
      <section className="mx-auto flex w-full max-w-3xl flex-col items-center gap-6 px-5 py-16 text-center sm:px-8 sm:py-24">
        {/* The floating animation is decorative and is neutralised entirely
            by src/frontend/design-system/tokens.css's blanket prefers-reduced-motion rule — no
