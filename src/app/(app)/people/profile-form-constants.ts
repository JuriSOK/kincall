...
// SCHEDULE_STATE_LABEL) moved to src/shared/presentation/format-schedule.ts in Stage D,
// and the conversation-profile/language display labels (formerly
// PROFILE_LABELS here) moved to src/shared/presentation/labels.ts in the UI/UX
...
// server accepts any valid IANA identifier (src/shared/validation/profile.ts's
