import type { InterventionSummary } from "@/backend/presentation/intervention-summary";

// Stage F (DEC-019): the confirmed-intervention card. Rendered ONLY when
// src/backend/presentation/intervention-summary.ts returned a model — that module's
