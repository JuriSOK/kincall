...
// truth both the server-side validator (src/shared/validation/profile.ts) and the
// UI registry (src/frontend/components/avatars/registry.tsx) import, so the two can never
