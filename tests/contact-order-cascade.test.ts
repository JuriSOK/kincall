...
import type { CalleAdapter, CallResult, FamilyCallInput } from "@/lib/calle/adapter";
import { FAKE_SCENARIOS, type FakeScenarioId } from "@/lib/calle/fake-adapter";
import {
  createInMemoryStore,
  InMemoryRepository,
  type InMemoryStore,
} from "@/lib/database/in-memory-repository";
...
// (lib/orchestration/contact-order.ts). At the seeded default configuration —
...
// Hand-derived directly from lib/calle/fake-adapter.ts's FAKE_SCENARIOS
