...
// app/(app)/people/profile-form-constants.ts, where it originated as a
...
// lib/schedule/format-schedule.ts.
...
// PREFERRED_LANGUAGES in lib/validation/profile.ts. English display names
...
// CONVERSATION_PROFILES in lib/validation/profile.ts — the profiles
// prompts/companion-agent.ts actually implements guidance for.
...
// shape in lib/schedule/format-schedule.ts.
