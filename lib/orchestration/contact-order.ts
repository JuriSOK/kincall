...
// cascade tries FIRST. Nothing here places a call; lib/orchestration/engine.ts
...
// lib/orchestration/engine.ts's own contactBlockedReason/selectCascadeTarget,
...
// lib/schedule/next-check-in.ts already relies on.

import type { TrustedContact } from "../database/types";

const TIME_PATTERN = /^([01]\d|2[0-3]):([0-5]\d)$/;

// lib/validation/profile.ts independently validates "HH:MM" at the input
