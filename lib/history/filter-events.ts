import type { EventOutcomeCategory, HistoryEventView } from "@/lib/presentation/history-view";

export interface HistoryFilters {
  personId?: string;
  // The product's own outcome vocabulary (DEC-011), not a raw EventStatus —
  // see lib/presentation/history-view.ts's categorizeEventOutcome.
...
// Pure filtering over already-built views (lib/presentation/history-view.ts),
