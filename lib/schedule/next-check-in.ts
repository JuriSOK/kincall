...
// lib/presentation/format-date.ts already relies on) — safe, dependency-free,
...
export interface CheckInSchedule {
  ...
  // process's. Assumed already validated (lib/validation/profile.ts's
...
// Mirrors lib/validation/profile.ts's CALL_TIME_PATTERN exactly (not
...
// same trick lib/presentation/format-date.ts's formatDayKey already uses.
