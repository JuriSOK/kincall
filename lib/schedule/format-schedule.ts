...
// — moved here from app/(app)/people/profile-form-constants.ts, which now
...
import type { NextCheckInResult } from "./next-check-in";
...
// lib/presentation/format-date.ts's fixed-Europe/Paris formatDayKey, because
...
// lib/presentation/format-date.ts's own fr-FR formatting of the fixed
